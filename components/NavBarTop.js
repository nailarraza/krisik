...
export default function NavBarTop() {
  ...
  return (
    <>
      ...
      <nav
        className={`navbar navbar-expand-xl navbar-light bg-color-primary border-bottom-primary shadow-sm ${
          isFixedNavbar ? "fixed-top" : ""
        }`}
      >
        <div className="container">
          <Link href="/">
          ...
          <div
            className="nav-link ms-auto order-0 order-xl-1 mr-2 ml-2"
            aria-current="page"
          >
            <br/> <ThemeToggle /> <br/>
          ...
          <div className="collapse navbar-collapse" id="navbarToggler">
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown ms-lg-1">
                ...
                <ul
                  className="dropdown-menu bg-color-primary"
              ...
              <li className="nav-item dropdown ms-lg-1">
               ...
               <li className="nav-item dropdown ms-lg-1">
                ...
                <ul
                  className="dropdown-menu bg-color-primary"
                  aria-labelledby="galeriDropdown"
                >
                  <li className="me-2">
              ...
              <li className="nav-item dropdown ms-lg-1">
                ...
                <ul
                  className="dropdown-menu bg-color-primary"
                  aria-labelledby="publikasiDropdown"
                >
                  <li className="me-2">
              ...
              <li className="nav-item mt-2 mt-xl-0 ms-lg-1">
                <ActiveLink activeClassName="active" href="https://sipendik.krisikpudak.com/">

...
export default function Form({ identity }) {
  ...
  const submitForm = async (event) => {
    ...
    localStorage.setItem("namaDesa", "krisik");
    localStorage.setItem("namaKecamatan", "krisik");
    router.push("/");
  };
    ...
    <>
      ...
      <Head>
        ...
        <meta
          ...
          content={`Website Resmi Desa. Media komunikasi dan transparansi Pemerintah Desa`}
        />
        <meta
          property="og:image"
        ...
        <div className="container my-5">
          <form className="mx-auto col-7" onSubmit={submitForm}>
            <div className="mb-3">
              <label
                htmlFor="namaDesa"
                className="form-label text-color-secondary"
              >
                Nama Desa
              </label>
              <input

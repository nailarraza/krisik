...
export default function BlogDetail({ post, randomPosts, randomAgendas }) {
  ...
  const popover = (
    <Popover
      id="popover-basic"
      className="bg-card-primary border-color-primary"
    >
      <Popover.Body>
        <FacebookShareButton
            ...
            <div className="col-lg-8">
              <div className="card bg-card-primary shadow-blog border-0">
                ...
                <div className="card-body">
                  <h3 className="card-title text-color-primary">
                    {post.title}
                  </h3>
                  ...
                  <p className="card-text mt-2 text-color-secondary">
                    {post.body}
                  </p>
